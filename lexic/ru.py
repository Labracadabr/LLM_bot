lexicon: dict[str:str] = {
    ...
    'model': 'Выберите модель нейросети. Сейчас: <code>{}</code>'
             '\n▫️ mixtral-8x7b - универсальный'
             '\n▫️ llama3-70b - способен материться'
             '\n▫️ codestral - заточен под программный код'
             '\n▫️ gpt-4o-mini - нельзя выбрать, применяется автоматически для чтения ваших фото'
             ,
